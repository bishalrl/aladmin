...
/** Step 2 for a course day: music — call after mantra is completed in the app. */
export async function GET(
  ...
  try {
    const blocked = await enforcePublicApi(request, {
      path: "/api/v1/yantramed/course/days/[day]/music",
    });
    ...
    const data = await yantramedCourseService.getCourseDayMusic(dayNumber);

    await logApiRequest({
      projectId: project.id,
      method: "GET",
      path: `/api/v1/yantramed/course/days/${dayNumber}/music`,
      statusCode: 200,
