...
export default function UserDetailPage() {
  ...
  useEffect(() => {
    apiGet<User>(`/api/admin/projects/yantramed/users/${params.uid}`)
      .then(setUser)
  ...
  return (
    <div>
      <PageHeader
        title="User details"
        description="YantraMed Firebase user"
        actions={
          <Link href="/admin/yantramed/users" className="text-sm text-teal-700">
            Back to users
          </Link>
        }
      />
